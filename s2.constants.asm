...
; note: $20 is unused and available
inertia =		$14 ; and $15 ; directionless representation of speed... not updated in the air
double_jump_flag =	$1F
double_jump_property =	$21
...
wing_fortress_zone_act_2 =	(wing_fortress_zone<<8)|$01
...
sky_chase_zone_act_2 =		(sky_chase_zone<<8)|$01
; ---------------------------------------------------------------------------
...
GameModeID_MainOptions =	id(GameMode_MainOptions) ; 2C
...
PalID_SSZ1 =	id(PalPtr_SSZ1) ; 7
PalID_SSZ2 =	id(PalPtr_SSZ2)
...
PLCID_SpecStageBombs =	id(PLCptr_SpecStageBombs) ; 3C
PLCID_WfzBoss =		id(PLCptr_WfzBoss) ; 3D
PLCID_Tornado =		id(PLCptr_Tornado) ; 3E
PLCID_Capsule =		id(PLCptr_Capsule) ; 3F
PLCID_Explosion =	id(PLCptr_Explosion) ; 40
PLCID_Miles1up =	id(PLCptr_Miles1up)
PLCID_MilesLife =	id(PLCptr_MilesLife)
PLCID_Tails1up =	id(PLCptr_Tails1up)
PLCID_TailsLife =	id(PLCptr_TailsLife)
PLCID_ResultsTails =	id(PLCptr_ResultsTails) ; 41
...
ObjID_Stego =			id(ObjPtr_Stego)		; 4D
ObjID_Crocobot =		id(ObjPtr_Crocobot)		; 4E
ObjID_Redz =			id(ObjPtr_Redz)			; 4F
...
ObjID_OWZBoss =			id(ObjPtr_OWZBoss)		; D0
...
; you may need to insert a dummy zMusIDPtr in the $00 slot

MusID__First = idstart
MusID_2PResult =	id(zMusIDPtr_2PResult)	; 81
MusID_EHZ1 =		id(zMusIDPtr_EHZ1)
MusID_EHZ2 =		id(zMusIDPtr_EHZ2)
...
MusID_DEZ1 =		id(zMusIDPtr_DEZ1)
MusID_RWZ2 =		id(zMusIDPtr_RWZ2)
MusID_OWZ1 =		id(zMusIDPtr_OWZ1)
MusID_MTZ2 =		id(zMusIDPtr_MTZ2)
...
SndID_Flying =		id(SndPtr_Flying)
SndID_FlyTired =	id(SndPtr_FlyTired)
...
AniIDTailsAni_FlyCarry		= id(TailsAni_FlyCarry_ptr)			; 32 ; $22
AniIDTailsAni_FlyCarry2		= id(TailsAni_FlyCarry2_ptr)			; 33 ; $23
AniIDTailsAni_FlyTired		= id(TailsAni_FlyTired_ptr)			; 34 ; $24
...
Delete_water:			ds.b	1	; used in HPZ to delete the water during the long shaft
...
Flying_carrying_Sonic_flag:	ds.w	1
				ds.b	2	; seems unused
Plc_Buffer_End:
...
ScreenShift:			ds.b	1
PalMode:			ds.b	1	; used to update the vertical interrupts every 6 frames
...
Life_count:			ds.b	1
Super_Tails_flag:		ds.b	1	; simply used once to prevent a weird bug
				ds.b	2	; unused
...
Score:				ds.l	1	; 4 bytes
				ds.b	6	; $FFFFFE2B-$FFFFFE2F ; seems unused
...
Main_options_selection:		ds.b	6	; $FFFFFF9A-$FFFFFF9F ; seems unused
...
ArtTile_ArtNem_Stego                  = $03B2
ArtTile_ArtNem_Redz                   = $0500
ArtTile_ArtNem_Batbot                 = $0530
ArtTile_ArtNem_Motobug		      = $0340
ArtTile_ArtNem_Crocobot               = $0300

; ---------------------------------------------------------------------------
; Fucking SRAM shit goes here

Saved_Emerald_count =			$200004